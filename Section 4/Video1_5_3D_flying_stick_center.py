...
def run_3d_game():    
    ...
    while run_game:
        ...
        vertices_dancing_stick_center = np.array(((-1, -1, -1), (1, 1, 1), (1, 1, 1)))         # ties stick to center, use spacebar to see
        shape_points_2 = ((0, 1), (0, 2))
        draw_shape(vertices_dancing_stick_center, shape_points_2, RED)
