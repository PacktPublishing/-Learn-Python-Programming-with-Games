...
class Weapon():
    ...
    def __init__(self):
        fire_x, fire_y = self.position_weapon()
    ...
    def fire(self, new_pos_x=3, new_pos_y=3):
        Weapon.weapon_position[0] += new_pos_x
        Weapon.weapon_position[1] += new_pos_y
...
def run_3d_game():    
    ...
    while run_game:
        ...
        print('Weapon.weapon_count:', Weapon.weapon_count)
        if Weapon.weapon_count <= 400:
            weapon.fire(0, 3)
        elif Weapon.weapon_count <= 800:
            weapon.fire(-3, 3)
        elif Weapon.weapon_count <= 1200:
            weapon.fire()
        else:
        ...
        print('weapon:', weapon.weapon_position)
