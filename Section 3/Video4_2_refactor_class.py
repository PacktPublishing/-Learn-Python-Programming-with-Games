...
class Player():
    def __init__(self, player_image, width, height, is_spritesheet=False, num_of_sprites=9):
        ...
        if is_spritesheet:
#             self.player_width = self.player_img_rect.width   
#             self.player_height =  self.player_img_rect.height            
#              
...
def run_game():
    ...
    while run_game:
        ...
        if pressed_keys[K_SPACE]: 
            pass
#TODO: ACCEPT BOTH PLAYERS
#             player_img_idx += 1
#             if player_img_idx >= 9:
#                 player_img_idx = 0
#             player.player_img = player.sprite_list[player_img_idx]
