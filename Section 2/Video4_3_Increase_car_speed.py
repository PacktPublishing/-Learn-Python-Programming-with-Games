...
class CanvasAndCar():
    ...
    def after_turtle_game_area_creation(self):
        ...
        self.speed_of_car = 10                                  # starting car speed
    ...
    def drive_forward(self, _event): 
        ...
        self.car_pos_y -= math.cos(math.radians(self.angle)) * self.speed_of_car   
        self.car_pos_x -= math.sin(math.radians(self.angle)) * self.speed_of_car 
        self.place_car()
